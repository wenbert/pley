...
def business_view(request, business_id):
    ...
    g = geocoders.Google(domain="google.com.ph", resource='maps/geo')
    
    
    string_location = business_item.name + ' near ' + business_item.address2 + ', ' + business_item.city + ', ' + business_item.province + ', ' + business_item.country
